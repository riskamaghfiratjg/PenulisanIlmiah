                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-user"></i> Data Paket
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead align="text-center">
                                        <tr>
                                            <th align="text-center">No.</th>
                                            <th>Kode Lelang</th>
                                            <th>No. Paket-Nama Pokja</th>
                                            <th>Pagu</th>
                                            <th>HPS</th>
                                            <th>Waktu Pekerjaan (Hari)</th>
                                            <th>Sumber Dana</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM paket");
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $row['nama_pokja'];?></td>
                                            <td><?php echo $row['pagu'];?></td>
                                            <td><?php echo $row['hps'];?></td>
                                            <td><?php echo $row['jangka_waktu'];?></td>
                                            <td><?php echo $row['sumber_dana'];?></td>
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/editpaket.php?kode_lelang=<?php echo $row['kode_lelang'];?>">
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>
                                               <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="../admin/Model/deletepaket.php?kode_lelang=<?php echo $row['kode_lelang'];?>" onclick="return confirm('Anda yakin ingin menghapus Kode Lelang <?php echo $row['kode_lelang']; ?>?');">
