            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 include 'Model/koneksi.php';
                  ...
                  //query
                  $sql="SELECT * FROM daftar_penawar where NPWP='$row'";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                             <form method="post" action="Model/updatepenawar.php">
                              <table width="800" border="0" align="center">
                               <tr>
                                  <td width="350" height="45"><label>NPWP</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="NPWP" size="40" value="<?php echo $row["NPWP"];?>" readonly></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Nama Perusahaan</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="nama_perusahaan" size="40" value="<?php echo $row["nama_perusahaan"];?>"></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Nama Direktur</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="nama_direktur" size="40" value="<?php echo $row["nama_direktur"];?>"></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Alamat</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><textarea class="form-control" name="alamat" rows="3" required><?php echo $row['alamat'];?></textarea></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Jangka Waktu Pelaksanaan (HARI)</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="jangka_wp" size="40" value="<?php echo $row["jangka_wp"];?>"></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Harga Penawaran</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="harga_penawaran" size="40" value="<?php echo $row["harga_penawaran"];?>"></td>
                                </tr>
                                <tr>
                                     <td colspan="2">&nbsp;</td>
                                     <td align="right"><input type="submit" class="btn btn-success btn-submit" name="simpan" value="Update">
                                     <a href="daftarpenawar.php" class="btn btn-default btn-reset">Batal</a></td>
                                   </tr>
                              </table>
                            </form>
                            <?php
