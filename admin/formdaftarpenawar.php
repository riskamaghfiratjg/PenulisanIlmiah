                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/insertpenawar.php">
                              <table width="800" border="0" align="center">
                               <tr>
                                  <td width="350" height="45"><label>NPWP</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="NPWP" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Nama Perusahaan</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="nama_perusahaan" size="40" ></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Nama Direktur</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="nama_direktur" size="40" required></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Alamat</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><textarea class="form-control" name="alamat" rows="3"></textarea></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Jangka Waktu Pelaksanaan (HARI)</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="jangka_wp" size="40" ></td>
                                </tr>
                                <tr>
                                  <td width="350" height="45"><label>Harga Penawaran</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="harga_penawaran" size="40"></td>
                                </tr>
                                <tr>
                                  <td colspan="2">&nbsp;</td>
