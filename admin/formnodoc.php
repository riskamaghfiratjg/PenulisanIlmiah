                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <i class="glyphicon glyphicon-edit"></i> 
                           Input Data No. Dokumen
                        </div>
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/insertnodoc.php">
                              <table width="800" border="0" align="center">
                               <tr>
                                  <td width="200" height="45"><label>Nomor Dokumen </label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="no_dokumen" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Kegiatan</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><textarea class="form-control" name="kegiatan" rows="3" required></textarea></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Jenis Dokumen</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="jenis_dok" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Quota</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="quota" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Actual</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="actual" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Durasi (Hari)</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="durasi" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Mulai</label></td>
                                  <td width="19">:</td>
                                  <td width="328"><input type="date" class="form-control" name="mulai"></td>
                                </tr>
                                <tr>
                                  <td width="200" height="45"><label>Selesai</label></td>
                                  <td width="19">:</td>
                                    <td width="328"><input type="date" class="form-control" name="selesai"></td>
                                </tr>
                                <tr>
                                  <td colspan="2">&nbsp;</td>
