                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/insertberitaacara.php">
                              <table width="800" border="0" align="center">
                                ...
                                <tr>
                                  ...
                                  <td width="19">:</td>
                                  <td width="328"><input type="text" class="form-control" name="hasil_penilaian" size="40" ></td>
                                </tr>
                                <tr>
                                  <td colspan="2">&nbsp;</td>
