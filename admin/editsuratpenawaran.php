                            ...
                            <form method="post" action="Model/updatesuratpenawaran.php">
                              <table width="800" border="0" align="center">
                                ...
                                <tr>
                                  ...
                                  if ($row['ttd_sp']=="Ada"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="ttd_sp" value="Ada" checked> Ada
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="ttd_sp" value="Tidak Ada" checked> Tidak Ada
                                    </label>
                                  <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td width="328">
                                  <?php
                                  if ($row['tujuan_sp']=="Sesuai"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="tujuan_sp" value="Sesuai" checked>Sesuai  
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="tujuan_sp" value="Tidak Sesuai" checked> Tidak Sesuai
                                    </label>
                                    <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td width="328">
                                    <?php
                                  if ($row['paket_sp']=="Sesuai"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="paket_sp" value="Sesuai" checked>Sesuai  
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="paket_sp" value="Tidak Sesuai" checked> Tidak Sesuai
                                    </label>
                                    <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td width="19">:</td>
                                  <td width="328">
                                   <input type="text" class="form-control" name="jangka_sp" value="<?php echo $row["jangka_sp"];?>">
                                  </td>
                                </tr>
                                 <tr>
                                  ...
                                  <td width="328">
                                    <?php
                                  if ($row['pelaksanaan_sp']=="Sesuai"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="pelaksanaan_sp" value="Sesuai" checked>Sesuai  
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="pelaksanaan_sp" value="Tidak Sesuai" checked> Tidak Sesuai
                                    </label>
                                    <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  if ($row['tgl_sp']=="Ada"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="tgl_sp" value="Ada" checked> Ada
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="tgl_sp" value="Tidak Ada" checked> Tidak Ada
                                    </label>
                                  <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td width="328">
                                  <?php 
                                  if($row['penilaian_sp']=="Memenuhi Syarat"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_sp" value="Memenuhi Syarat" checked> Memenuhi Syarat
                                    </label>
                                    <label class="radio-inline">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_sp" value="Tidak Memenuhi Syarat"  checked> Tidak Memenuhi Syarat
                                    </label>
                                    <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td width="328">
                                  <?php 
                                  if($row['penilaian_sp']=="LULUS"){?>
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_evaluasi" value="Memenuhi Syarat" checked> LULUS
                                    </label>
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_evaluasi" value="Tidak Memenuhi Syarat"> GUGUR
                                    </label>
                                    <?php
                                  } else { ?>
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_evaluasi" value="Memenuhi Syarat"> LULUS
                                    </label>
                                    <label class="radio-inline">
                                      <input type="radio" name="penilaian_evaluasi" value="Tidak Memenuhi Syarat"  checked> GUGUR
                                    </label>
                                    <?php
                                  } ?>
                                  </td>
                                ...
                                <tr>
                                     ...
                                     <a href="daftarsuratpenawaran.php" class="btn btn-default btn-reset">Batal</a></td>
                                   </tr>
                              </table>
                            </form>
                            <?php
