                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-user"></i> Data No. Dokumen
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM no_doc");
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/editnodoc.php?no_dokumen=<?php echo $row['no_dokumen'];?>">
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>
                                               <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="../admin/Model/deletenodoc.php?no_dokumen=<?php echo $row['no_dokumen'];?>" onclick="return confirm('Anda yakin ingin menghapus No. Dokumen <?php echo $row['no_dokumen']; ?>?');">
