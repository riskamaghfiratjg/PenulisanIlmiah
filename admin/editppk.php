            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 include 'Model/koneksi.php';
                  ...
                  //query
                  $sql="SELECT * FROM ppk where NIP='$row'";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/updateppk.php">
                              <table width="500" border="0" align="center">
                                <tr>
                                  <td width="133" height="45"><label>NIP PPK</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="NIP" size="40" value="<?php echo $row["NIP"];?>" readonly></td>
                                </tr>
                                <tr>
                                  <td width="133" height="45"><label>Nama PPK</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="nama_ppk" size="40" value="<?php echo $row["nama_ppk"];?>"></td>
                                </tr>
                                <tr>
                                  <td width="133" height="45"><label>Jabatan PPK</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="jabatan_ppk" size="40" value="<?php echo $row["jabatan_ppk"];?>"></td>
                                </tr>
                                <tr>
                                  <td width="133" height="45"><label>Instansi</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="instansi" size="40" value="<?php echo $row["instansi"];?>"></td>
                                </tr>
                                <tr>
                                     <td colspan="2">&nbsp;</td>
                                     <td align="right"><input type="submit" class="btn btn-success btn-submit" name="simpan" value="Update">
                                     <a href="daftarppk.php" class="btn btn-default btn-reset">Batal</a></td>
                                   </tr>
                              </table>
                            </form>
                            <?php
