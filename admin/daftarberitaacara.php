                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-user"></i> Data Berita Acara
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>NPWP</th>
                                            <th>Penawaran Adm</th>
                                            <th>Penawaran Teknis</th>
                                            <th>Rekapitulasi</th>
                                            <th>Rincian Biaya</th>
                                            <th>Dok. Kualifikasi</th>
                                    ...
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM berita_acara ORDER BY NPWP DESC");
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $row['penawaran_adm'];?></td>
                                            <td><?php echo $row['penawaran_teknis'];?></td>
                                            <td><?php echo $row['rekapitulasi'];?></td>
                                            <td><?php echo $row['rincian_biaya'];?></td>
                                            <td><?php echo $row['dok_kualifikasi'];?></td>
                                            <td><?php echo $row['hasil_penilaian'];?></td>
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/editberitaacara.php?NPWP=<?php echo $row['NPWP'];?>">
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>
                                               <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="../admin/Model/deleteberitaacara.php?NPWP=<?php echo $row['NPWP'];?>" onclick="return confirm('Anda yakin ingin menghapus NPWP <?php echo $row['NPWP']; ?>?');">
