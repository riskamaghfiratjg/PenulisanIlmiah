                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/inserthakakses.php">
                              <table width="500" border="0" align="center">
                                <tr>
                                  <td width="133" height="45"><label>Email</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="Email" class="form-control" name="email" size="40"></td>
                                </tr>
                                <tr>
                                  <td width="133" height="45"><label>Password</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="password" size="40"></td>
                                </tr>
                                <tr>
                                  <td colspan="2">&nbsp;</td>
                                  <td align="right"><button class="btn btn-success btn-submit" name="simpan">Registrasi</button></td>
                                </tr>
                              </table>
                            </form>
                            </div>
