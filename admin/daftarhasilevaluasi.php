                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-user"></i> Data Hasil Evaluasi
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Penilaian Surat Penawaran</th>
                                            <th>Hasil Penilaian Evaluasi</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM surat_penawaran WHERE penilaian_evaluasi='LULUS'");
                                        ...
                                        <tr class="">
                                            ...
                                            <td><?php echo $row['penilaian_evaluasi'];?></td>
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/infohasil.php?nama_perusahaan=<?php echo $row['nama_perusahaan'];?>">
