                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-user"></i> Data Penawar
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM daftar_penawar ORDER BY nama_perusahaan DESC");
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/editpenawar.php?NPWP=<?php echo $row['NPWP'];?>">
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>
                                               <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="../admin/Model/deletepenawar.php?NPWP=<?php echo $row['NPWP'];?>" onclick="return confirm('Anda yakin ingin menghapus Perusahaan <?php echo $row['nama_perusahaan']; ?>?');">
