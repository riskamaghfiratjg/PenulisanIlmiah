                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      <?php
                                            ...
                                            $no=0;
                                            $result = mysqli_query($link, "SELECT * FROM ppk ORDER BY nama_ppk DESC");
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                               <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-success btn-sm' href="../admin/editppk.php?NIP=<?php echo $row['NIP'];?>">
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>
                                               <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="../admin/Model/deleteppk.php?NIP=<?php echo $row['NIP'];?>" onclick="return confirm('Anda yakin ingin menghapus Nama PPK <?php echo $row['nama_ppk']; ?>?');">
