            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 include 'Model/koneksi.php';
                  ...
                  //query
                  $sql="SELECT * FROM login where email='$row'";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            <form method="post" action="Model/updatehakakses.php">
                              <table width="500" border="0" align="center">
                                <tr>
                                  <td width="133" height="45"><label>Email</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="Email" class="form-control" name="email" size="40" value="<?php echo $row["email"];?>" readonly></td>
                                </tr>
                                <tr>
                                  <td width="133" height="45"><label>Password</label></td>
                                  <td width="28">:</td>
                                  <td width="317"><input type="text" class="form-control" name="password" size="40" value="<?php echo $row["password"];?>"></td>
                                </tr>
                                <tr>
                                     <td colspan="2">&nbsp;</td>
                                     <td align="right"><input type="submit" class="btn btn-success btn-submit" name="simpan" value="Update">
                                     <a href="daftarhakakses.php" class="btn btn-default btn-reset">Batal</a></td>
                                   </tr>
                              </table>
                            </form>
                            <?php
